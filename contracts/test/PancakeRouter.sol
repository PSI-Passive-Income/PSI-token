...
library TransferHelper {
    ...
    function safeTransferETH(address to, uint value) internal {
        (bool success, bytes memory ret) = to.call{value:value}(new bytes(0));
        require(success, string(abi.encodePacked('TransferHelper: ETH_TRANSFER_FAILED - ', _getRevertMsg(ret))));
    }
